            ...
            <div class="form-group">
                ...
                <label for="">Item</label><br>
                  <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input" type="radio" name="barang" id="inlineRadio1" value="TV" <?php echo (($item == "TV")? "Checked" : "") ?>>
                    <label class="form-check-label" for="inlineRadio1">TV</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="barang" id="inlineRadio2" value="Refrigator" <?php echo (($item == "Refrigator")? "Checked" : "") ?>>
                    <label class="form-check-label" for="inlineRadio2">Refrigator</label>
                    </div>
                    <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="mesin_cuci" id="inlineRadio3" value="Washing Machine" disabled>
